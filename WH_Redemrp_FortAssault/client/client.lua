...
Citizen.CreateThread(function()
	...
	Citizen.Wait(0)
		...
		if betweencoords < 2.0 then
			...
			TriggerServerEvent("WH_Redemrp_FortAssault:startToRob", function()
			isRobbing = true
			end)
			end
		end
...
RegisterNetEvent('WH_Redemrp_FortAssault:startAnimation')
AddEventHandler('WH_Redemrp_FortAssault:startAnimation', function()
	...
	ClearPedTasksImmediately(PlayerPedId())
		Wait(500)
    TriggerEvent("WH_Redemrp_FortAssault:startTheEvent", function()
    end)
end)

RegisterNetEvent("WH_Redemrp_FortAssault:startTimer")
AddEventHandler("WH_Redemrp_FortAssault:startTimer",function()
	timers = true
	TriggerEvent("WH_Redemrp_FortAssault:startTimers")
		while timers do
		Citizen.Wait(0)
		...
		if timerCount == 0 then
			...
			Citizen.Wait(1000)
			TriggerServerEvent("WH_Redemrp_FortAssault:payout", function()
		end)
		end
	end
end)

AddEventHandler("WH_Redemrp_FortAssault:startTimers",function()
Citizen.CreateThread(function()
    while timers do
...
RegisterNetEvent("WH_Redemrp_FortAssault:startTheEvent")
AddEventHandler("WH_Redemrp_FortAssault:startTheEvent",function(num,typey)
